...
const Alltabs = () => {
  ...
  const handleActiveClick = () => {
    setActiveTab("1");
    fetchData("http://localhost:3001/api/proposals/status/active");
  };

  const handleCompletedClick = () => {
    setActiveTab("2");
    fetchData("http://localhost:3001/api/proposals/status/approved");
  };

  const handleRejectedClick = () => {
    setActiveTab("3");
    fetchData("http://localhost:3001/api/proposals/status/rejected");
  };
